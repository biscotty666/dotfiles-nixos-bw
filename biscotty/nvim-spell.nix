...
{
  xdg.configFile = {
    "nvim/spell/fr.utf-8.spl".source = nvim-spell-fr-utf8-dictionary;
    "nvim/spell/es.utf-8.spl".source = nvim-spell-es-utf8-dictionary;
    "nvim/spell/fr.utf-8.sug".source = nvim-spell-fr-utf8-suggestions;
    "nvim/spell/fr.latin1.spl".source = nvim-spell-fr-latin1-dictionary;
    "nvim/spell/fr.latin1.sug".source = nvim-spell-fr-latin1-suggestions;
    "nvim/spell/es.utf-8.sug".source = nvim-spell-es-utf8-suggestions;
    "nvim/spell/es.latin1.spl".source = nvim-spell-es-latin1-dictionary;
    "nvim/spell/es.latin1.sug".source = nvim-spell-es-latin1-suggestions;
  };
}
