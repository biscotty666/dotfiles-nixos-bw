{
  programs.plasma = {
    ...
    shortcuts = {
      ...
      "services/brave-browser.desktop"._launch = "Ctrl+Alt+B";
      "services/brave-browser.desktop".new-private-window = "Meta+Ctrl+Alt+P";
    ...
    configFile = {
      ...
      kdeglobals.KScreen.ScreenScaleFactors = "eDP-1\x3d1;HDMI-A-1\x3d1;";
      ...
      kwinrc.Script-karousel.presetWidths = "33%, 50%, 66%, 100%";
